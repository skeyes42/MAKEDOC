...
cycle, building from an existing {{Phase}}-tier requisition.
...
3. In the MAKEDOC Dashboard document list, locate the most recent **{{Tier}} tier solicitation** row 
4. Right-click that row.
5. Choose **Build to award...** from the context menu.
6. In the **Select Document Type** dialog, choose **{{Tier}} tier award**.
7. Confirm the **MAKEDOC — Build To: {{Tier}} tier award** Document Assembly window opens.
...
14. The Windows **Save As** dialog opens. The default filename
    (e.g. `{{Tier}} tier award_<uuid>_<datetime>.docx`) and default folder
...
16. Confirm the Document Assembly status bar reads
    "Saved: {{Phase}} tier award_<filename>."
