...
3. In the MAKEDOC Dashboard document list, locate the most recent **{{Tier}} tier requisition** 
4. Right-click that row.
5. Choose **Build to solicitation...** from the context menu.
6. In the **Select Document Type** dialog, choose **{{Tier}} tier solicitation**.
7. Confirm the **MAKEDOC — Build To: {{Tier}} tier solicitation** Document Assembly window opens.
...
14. The Windows **Save As** dialog opens. The default filename
    (e.g. `{{Tier}} tier solicitation_<uuid>_<datetime>.docx`) and default folder
...
16. Confirm the Document Assembly status bar reads
    "Saved: {{Phase}} tier solicitation_<filename>."
