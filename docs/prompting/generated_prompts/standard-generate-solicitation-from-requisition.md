...
3. In the MAKEDOC Dashboard document list, locate the most recent **standard tier requisition** 
...
7. Confirm the **MAKEDOC — Build To: standard tier solicitation** Document Assembly window opens.
