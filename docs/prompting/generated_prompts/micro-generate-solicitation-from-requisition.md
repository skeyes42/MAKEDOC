...
3. In the MAKEDOC Dashboard document list, locate the most recent **micro tier requisition** 
...
7. Confirm the **MAKEDOC — Build To: micro tier solicitation** Document Assembly window opens.
