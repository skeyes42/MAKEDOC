...
3. In the MAKEDOC Dashboard document list, locate the most recent **micro tier solicitation** row 
...
7. Confirm the **MAKEDOC — Build To: micro tier award** Document Assembly window opens.
