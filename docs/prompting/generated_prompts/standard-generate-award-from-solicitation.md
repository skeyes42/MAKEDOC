# Generate a Award from a Solicitation
...
cycle, building from an existing -tier requisition.
...
3. In the MAKEDOC Dashboard document list, locate the most recent **standard tier solicitation** row 
...
7. Confirm the **MAKEDOC — Build To: standard tier award** Document Assembly window opens.
