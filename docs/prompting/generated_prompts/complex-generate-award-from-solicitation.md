...
3. In the MAKEDOC Dashboard document list, locate the most recent **complex tier solicitation** row 
...
7. Confirm the **MAKEDOC — Build To: complex tier award** Document Assembly window opens.
