# Generate a Award from a Solicitation for Micro Tier
...
3. In the MAKEDOC Dashboard document list, locate the most recent **Micro tier solicitation** row (Document type = "Micro tier solicitation", Tier = "micro").
4. Right-click that row.
5. Choose **Build to award...** from the context menu.
6. In the **Select Document Type** dialog, choose **Micro tier award**.
7. Confirm the **MAKEDOC — Build To: Micro tier award** Document Assembly
   window opens. 
...
11. In the Fill-in Values dialog, supply the following values
    ...
    - **PO Number** = `128345878`
    - **Title** = `Award pencils and batteries`
