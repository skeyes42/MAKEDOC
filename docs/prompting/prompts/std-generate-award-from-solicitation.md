# Generate a Award from a Solicitation for Standard Tier
...
3. In the MAKEDOC Dashboard document list, locate the most recent **Standard tier solicitation** row (Document type = "Standard tier solicitation", Tier = "standard").
4. Right-click that row.
5. Choose **Build to award...** from the context menu.
6. In the **Select Document Type** dialog, choose **Standard tier award**.
7. Confirm the **MAKEDOC — Build To: Standard tier award** Document Assembly
   window opens. 
...
11. In the Fill-in Values dialog, supply the following values
    ...
    - **Title** = `Motor oil and gasoline`
    - **Award Number** = `888880000`
